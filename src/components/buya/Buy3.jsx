            ...
            <section class="text-gray-600 body-font overflow-hidden">
                <div class="container px-5 py-24 mx-auto">
                    <div class="lg:w-4/5 mx-auto flex flex-wrap">
                        <img src={productData?.image} alt="ecommerce" class="lg:w-1/2 w-full lg:h-auto h-64 object-cover object-center rounded" id="3" />
                        <div class="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
                            ...
                            <div class="flex justify-content:space-between">
                                <Link to={CartItems}> <button class="flex m-auto text-white bg-indigo-500 border-0 py-2 px-6 focus:outline-none hover:bg-white-600 rounded">Add To Cart</button></Link>
